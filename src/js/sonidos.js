...
$('#contAnimales').html('<div class="arriba3"><div><input type="hidden" value="1"/><img src="'+rutaanimal[1]+'" class="btnAnimal" alt="'+nombreAnimal[1]+'"/></div><div><input type="hidden" value="2"/><img src="'+rutaanimal[2]+'" class="btnAnimal" alt="'+nombreAnimal[2]+'"/></div><div>Donde está el '+nombreAnimal[animalSeleccionado]+'</div><div><input type="hidden" value="3"/><img src="'+rutaanimal[3]+'" class="btnAnimal" alt="'+nombreAnimal[3]+'"/></div></div>');
}else if (puntuacion<30) {
animalSeleccionado=aleatorio(1,4);
$('#contAnimales').html('<div class="arriba4"><div><input type="hidden" value="1"/><img src="'+rutaanimal[1]+'" class="btnAnimal" alt="'+nombreAnimal[1]+'"/></div><div><input type="hidden" value="2"/><img src="'+rutaanimal[2]+'" class="btnAnimal" alt="'+nombreAnimal[2]+'"/></div><div>Donde está el '+nombreAnimal[animalSeleccionado]+'</div><div><input type="hidden" value="3"/><img src="'+rutaanimal[3]+'" class="btnAnimal" alt="'+nombreAnimal[3]+'"/></div><div><input type="hidden" value="4"/><img src="'+rutaanimal[4]+'" class="btnAnimal" alt="'+nombreAnimal[4]+'"/></div></div>');	
}else if (puntuacion<50) {
animalSeleccionado=aleatorio(1,5);
$('#contAnimales').html('<div class="arriba5"><div><input type="hidden" value="1"/><img src="'+rutaanimal[1]+'" class="btnAnimal" alt="'+nombreAnimal[1]+'"/></div><div><input type="hidden" value="2"/><img src="'+rutaanimal[2]+'" class="btnAnimal" alt="'+nombreAnimal[2]+'"/></div><div><input type="hidden" value="3"/><img src="'+rutaanimal[3]+'" class="btnAnimal" alt="'+nombreAnimal[3]+'"/></div><div>Donde está el '+nombreAnimal[animalSeleccionado]+'</div><div><input type="hidden" value="4"/><img src="'+rutaanimal[4]+'" class="btnAnimal" alt="'+nombreAnimal[4]+'"/></div><div><input type="hidden" value="5"/><img src="'+rutaanimal[5]+'" class="btnAnimal" alt="'+nombreAnimal[5]+'"/></div></div>');
}else if (puntuacion<75) {
animalSeleccionado=aleatorio(1,6);
$('#contAnimales').html('<div class="arriba6"><div><input type="hidden" value="1"/><img src="'+rutaanimal[1]+'" class="btnAnimal" alt="'+nombreAnimal[1]+'"/></div><div><input type="hidden" value="2"/><img src="'+rutaanimal[2]+'" class="btnAnimal" alt="'+nombreAnimal[2]+'"/></div><div><input type="hidden" value="3"/><img src="'+rutaanimal[3]+'" class="btnAnimal" alt="'+nombreAnimal[3]+'"/></div><div>Donde está el '+nombreAnimal[animalSeleccionado]+'</div><div><input type="hidden" value="4"/><img src="'+rutaanimal[4]+'" class="btnAnimal" alt="'+nombreAnimal[4]+'"/></div><div><input type="hidden" value="5"/><img src="'+rutaanimal[5]+'" class="btnAnimal" alt="'+nombreAnimal[5]+'"/></div><div><input type="hidden" value="6"/><img src="'+rutaanimal[6]+'" class="btnAnimal" alt="'+nombreAnimal[6]+'"/></div></div>');
}else if (puntuacion<100) {
animalSeleccionado=aleatorio(1,7);
$('#contAnimales').html('<div class="arriba7"><div><input type="hidden" value="1"/><img src="'+rutaanimal[1]+'" class="btnAnimal" alt="'+nombreAnimal[1]+'"/></div><div><input type="hidden" value="2"/><img src="'+rutaanimal[2]+'" class="btnAnimal" alt="'+nombreAnimal[2]+'"/></div><div><input type="hidden" value="3"/><img src="'+rutaanimal[3]+'" class="btnAnimal" alt="'+nombreAnimal[3]+'"/></div><div><input type="hidden" value="4"/><img src="'+rutaanimal[4]+'" class="btnAnimal" alt="'+nombreAnimal[4]+'"/></div><div>Donde está el '+nombreAnimal[animalSeleccionado]+'</div><div><input type="hidden" value="5"/><img src="'+rutaanimal[5]+'" class="btnAnimal" alt="'+nombreAnimal[5]+'"/></div><div><input type="hidden" value="6"/><img src="'+rutaanimal[6]+'" class="btnAnimal" alt="'+nombreAnimal[6]+'"/></div><div><input type="hidden" value="7"/><img src="'+rutaanimal[7]+'" class="btnAnimal" alt="'+nombreAnimal[7]+'"/></div></div>');
}else{
