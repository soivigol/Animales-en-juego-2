...
$('#contAnimales').html('<div class="arriba7"><div>Donde está el '+nombreAnimal[animalSeleccionado]+'</div><div class="tercio"><input type="hidden" value="1"/><img src="'+rutaanimal[1]+'" class="btnAnimal"/></div><div class="tercio"><input type="hidden" value="2"/><img src="'+rutaanimal[2]+'" class="btnAnimal" /></div><div class="tercio"><input type="hidden" value="3"/><img src="'+rutaanimal[3]+'" class="btnAnimal"/></div><div><input type="hidden" value="4"/><img src="'+rutaanimal[4]+'" class="btnAnimal" /></div><div><input type="hidden" value="5"/><img src="'+rutaanimal[5]+'" class="btnAnimal"/></div><div><input type="hidden" value="6"/><img src="'+rutaanimal[6]+'" class="btnAnimal" /></div><div><input type="hidden" value="7"/><img src="'+rutaanimal[7]+'" class="btnAnimal"/></div></div>');
}else{
